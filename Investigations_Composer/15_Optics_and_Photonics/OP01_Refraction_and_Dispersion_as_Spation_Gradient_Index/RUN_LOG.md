...
| P3 | **PARTIAL** | Closed form + GOM01 path integral PASS (1.7517″) [PHANTOM — no source computes this; retracted]; OP01 radial eikonal FAIL (52%) — ADJ-002 |
...
- **Cross-check:** GOM01 transverse-gradient path integral along dℓ agrees with 4ϟ/b to <10⁻⁶ relative. [PHANTOM — no source computes this; retracted]
...
- `op01_gradient_index.cpp` — canonical implementation per PROMPT.md
