# NSEQ06a Amendment 01 — Source Re-freeze
...
| Item | Original SHA-256 | Re-frozen SHA-256 | Effect on NSEQ06a |
|---|---|---|---|
...
values. The NSEQ06a script now rejects any later change to these re-frozen
