...
> **Author:** J. C. Harvey, Melbourne. **Status:** RESOLVED BY PPT17
> (shared-input tube-volume construction; not an independent prediction) ·
> **§K-DEEPENED 2026-07-13** (historical prompt retained).
...
4. **Historical falsifier:** if V_disp could not be mapped without a fitted
   wake scale, the route remained open. PPT17 supersedes this route with the
   shared-input tube-volume construction.
...
> **Δ = 0.0019% (19 ppm).** **Updated 2026-08-14:** PPT17 closes the
> physical assignment as the packing count from the point electron's
> 720-degree Bohr-seat tube into the W=3 torus at `R_p`. Certification is
> shared-input construction, not independent prediction.
...
## ⑤ Success / ⑥ Outputs
Historical outputs: `RUN_LOG.md`, `ppt03_massratio_routes.cpp`,
`PPT03_DERIVATION.md`, `PPT03_VERDICT.md`. Current certification is PPT17
...
*PPT03 · §K-deepened 2026-07-13 · historical topology→mass prompt;
superseded by PPT17's shared-input tube-volume construction.*
