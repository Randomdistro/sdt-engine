...
**TRIVIAL** — pure calculation using existing data.

## 7. Impact

- **If confirmed**: Shows SDT reproduces the 43"/century value from pressure gradients.
- **If not confirmed**: If the calculation gives a different value: the k-gradient model needs refinement.
