...
std::vector<Experiment> build_experiments() {
    ...
    std::vector<ExpTemplate> templates = {
        ...
        {"Proton-Electron Mass Ratio from Winding Numbers",
         "m_p/m_e = 6π⁵ is the shared-input packing count from the point electron's 720-degree Bohr-closure tube into the W=3 torus at R_p.", "Standard: m_p/m_e from quark masses, which are themselves unexplained.", "PPT17 resolves the geometric volume construction without claiming an independent prediction of the packing count.", "Verify tube-volume conservation and the point-electron occlusion profile.", "Computational.", "COMPLETED at construction level.", "HIGH", "The construction fixes the physical volume map.", "Scope: shared-input construction, not independent prediction.", "Electromagnetic", "Resolved construction"},
