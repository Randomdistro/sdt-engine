...
100 experiments derived from Spatial Displacement Theory predictions.
Each experiment specifies the SDT prediction, the standard model prediction,
the observable difference, feasibility, and impact.

**Author**: James Christopher Tyndall, Melbourne, Australia

---

## Index (E01–E20: Original Programme)
...
| E07 | Primordial Lithium Resolution | Archival data |
| E08 | Hubble Tension 3-Way Test | Future |
| E09 | Le Sage Thermal Budget | Calculable now |
| E10 | Casimir as Convergence Occlusion | Already measured |
| E11 | Pressure-Gradient Redshift | Derivable now |
...
## Index (E21–E100: Extended Programme)
...
| E97 | Earth Core Seismic Speed from Lattice Compression | Gravity / Occlusion | LOW | Archival analysis |
...
| Difficulty | Count |
|-----------|-------|
| Validated/Trivial | 33 |
| Low (archival/calculation) | 20 |
| Moderate (existing facilities) | 21 |
| High (frontier) | 22 |
| Extreme (megastructure/new physics) | 3 |
| Unmeasurable (current tech) | 2 |

---

*All predictions use empirically measured values only. No interpretive frameworks imported.*
