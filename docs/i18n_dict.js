...
"tp": {
  ...
  "SDT is built from exactly four irreducible primitives. Everything else — mass, directional response, time, temperature, entropy — is derived. The Clearing is this cycle’s wall opening, not a first moment. The antecedent is the previous recharge. There is no first origin.":
    "The formalism admits exactly four irreducible primitives; mass, directional response, time, temperature, and entropy enter as theorems, not inputs. The Clearing is this cycle’s radiative depinning, not a first moment. The antecedent is the previous recharge to c_far → 0. There is no first origin.",
  "@m_space":
    "Gap-free, contact-only relay medium: individually incompressible, collectively deformable. Icosahedral 12-around-1 packing; R<sub>spat</sub> = ℓ<sub>P</sub>/2. ℓ<sub>P</sub> is derived. The four primitives are said once on the Atlas.",
  ...
  "@m_note":
    "The old whitelist {ℓ<sub>P</sub>, c, ℏ, k<sub>B</sub>, T<sub>CMB</sub>, α, m<sub>e</sub>, m<sub>p</sub>} is rederived — not a second primitive set. ℓ<sub>P</sub> is mathematical; T<sub>CMB</sub> is the red-to-IR wall after 10.47 octaves. Seats and unit bridges: the inputs page. Every load-bearing constant carries provenance metadata: certification class A–F, delete-test assertion, risk flag.",
  ...
  "@a_shadow":
    "The projected-overlap account prices a candidate binding diagnostic from ΔA = N·πR<sub>p</sub>² − A<sub>∪</sub>. NSEQ04 tested that rule on the NSEQ05-CONTROL-3 geometric replay. It retains a total-binding correlation but fails the per-nucleon observable and is not promoted as the binding mechanism. The separate packing-radius relation R(A) = R<sub>p</sub>·(A/η)<sup>1/3</sup>, η = π/√18, remains a distinct zero-fit radius result.",
  "NSEQ05-CONTROL-3 replay: κ = 47.137184 MeV/fm² [CALIBRATED(1)], R²(total BE) = 0.796231, mean |relative error| = 44.39%; R²(BE/A) = −230.641525. Result: excluded as a per-nucleon binding law and retained only as a geometric control.":
    "NSEQ05-CONTROL-3 replay: κ = 47.137184 MeV/fm² [CALIBRATED(1)], R²(total BE) = 0.796231 and mean absolute relative error = 44.39%; R²(BE/A) = −230.641525. The per-nucleon binding law is excluded. The volume-price hypothesis E = P·ΔV is also excluded (NP05); E_bind = ℏ·Δω remains under test.",
  ...
  "Every spation released its stored energy simultaneously and omnidirectionally. The Clearing is this cycle’s wall, not a first moment. The CMB is not an afterglow — it is the current operating pressure of the lattice. Estimated age: ~48 Gyr.":
    "This cycle’s radiative depinning: infrared comes down, the bath is the operating pressure P(z) = P_conv·(1+z)⁴ — not an afterglow. The antecedent is the previous recharge. There is no first origin. Estimated elapsed count of this cycle: ~48 Gyr.",
  "@c_rot":
  ...
  "This cycle’s wall opening: the radiative boundary depins, infrared comes down, we sit in the microwave. Replaces a first-moment bang. The antecedent is the previous recharge. There is no first origin.":
    "This cycle’s radiative depinning, not a first moment. The antecedent is the previous recharge to c_far → 0. Observable baseline: P(z) = P_conv·(1+z)⁴.",
