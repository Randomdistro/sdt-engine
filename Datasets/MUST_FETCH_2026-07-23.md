...
| F11 | NP32 cross-fissioner test (added 2026-07-25) | Per-fissioner independent+cumulative yields, ALL commercial/experimental fissionables | IAEA NDS relnsd `independent_fy`/`cumulative_fy` | `Datasets/nuclear/fission_yields/` | **CACHED 2026-07-25** — 8 neutron-induced systems the endpoint serves: U-235 (canonical, in `nuclear/`), U-233, U-238, Th-232, Pu-239, Pu-241, Np-237, Am-241 (7 new × ind+cum = 14 files). See `fission_yields/README.md` |
| F12 | NP32 SF standard + minor actinides (added 2026-07-25) | **Cf-252 spontaneous-fission yields** (THE SF standard) + Pu-240/242(sf), Cm-242/244/246/248(sf), U-238(sf); neutron-induced Pu-240, Pu-242, Am-243, Cm-242…245, U-234/236, Np-238, Pa-231 | **NOT on relnsd** (returns empty). ENDF/B-VIII.0 (or JEFF-3.3/JENDL-5) **fission-yield sublibrary**, `MT=454` (independent) / `MT=459` (cumulative), via NNDC `www.nndc.bnl.gov/endf` or IAEA ENDF mirror — ENDF-format, needs a parser | `Datasets/nuclear/fission_yields/` | **BLOCKED-relnsd** (endpoint serves only the 8 above; Cf-252 SF is the key omission) |
