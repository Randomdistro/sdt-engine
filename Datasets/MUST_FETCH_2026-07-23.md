...
| F9 | NP30 §11 radial-load test + GOM19 P5(iii) — SHARED row (added 2026-07-23) | Elastic e-scattering charge-density profiles / form factors, doubly-magic ladder: ¹⁶O, ⁴⁰Ca, ⁴⁸Ca, ⁹⁰Zr, ¹³²Sn, ²⁰⁸Pb — decides "borne down from above" (inner-shell compression under closures) which rms radii cannot resolve | De Vries, De Jager & De Vries 1987 compilation (ADNDT 36, 495); Mainz/NIKHEF datasets | `Datasets/nuclear/` | WANTED — *note: the parallel session offered this pull; whichever session lands it first flips this row to CACHED* |
