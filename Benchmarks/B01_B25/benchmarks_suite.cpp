...
)
{
    ...
    out << "{\n"
        ...
        << "  },\n"
        << "  \"nuclear\": {\n"
        << "    \"speedOfLightMetresPerSecond\": " << measured::c << ",\n"
        << "    \"electronVoltJoules\": " << measured::eV_to_J << ",\n"
        << "    \"protonMassKg\": " << measured::m_p << ",\n"
        << "    \"neutronMassKg\": " << measured::m_n << ",\n"
        << "    \"deuteronMassKg\": " << measured::m_d << ",\n"
        << "    \"tritonMassKg\": " << measured::m_t << ",\n"
        << "    \"helionMassKg\": " << measured::m_He3 << ",\n"
        << "    \"protonMomentMuN\": " << measured::mu_P << ",\n"
        << "    \"neutronMomentMuN\": " << measured::mu_N << ",\n"
        << "    \"deuteronMomentMuN\": " << measured::mu_D << ",\n"
        << "    \"tritonMomentMuN\": " << measured::mu_T << ",\n"
        << "    \"helionMomentMuN\": " << measured::mu_He3 << ",\n"
        << "    \"deuteronQuadrupoleFm2\": "
        << measured::Q_deuteron_fm2 << ",\n"
        << "    \"deuteronBindingMeV\": " << measured::B_deuteron << ",\n"
        << "    \"tritonBindingMeV\": " << measured::B_triton << ",\n"
        << "    \"helionBindingMeV\": " << measured::B_helion << "\n"
        << "  },\n"
        << "  \"materials\": {\n"
        ...
        << "      \"lithium_baryon_count\": "
        << li_equal_size.baryon_count << ",\n"
        << "      \"uranium_baryon_count\": "
