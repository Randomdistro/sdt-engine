...
This directory contains the complete CQ36 investigation, proving analytically that:
...
2. ✓ **No unresolved dependencies** — all references to CQ02, Laws I-VI are closed
...
- Verify dependencies with CQ02, CQ11, Laws I-VI

---

## Key Equations

### Vortex Geometry (from CQ02)
```
...
### SDT Framework
- CQ02 INVESTIGATION.md: Vortex Equilibrium Quantisation (5/5 proofs)
- CQ11 INVESTIGATION.md: Trefoil Confinement
...
**Investigation**: CQ36 — Winding Number Stability and Reconnection Dynamics  
...
**Next Investigation**: CQ37 or CQ36a/b/c (future extensions)
