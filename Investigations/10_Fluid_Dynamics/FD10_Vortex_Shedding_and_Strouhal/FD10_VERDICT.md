...
|---|---|---|---|---|
| Periodic two-sided (`ℓ=2`) wake exists | SDT-derived | known-match (Kármán street) | C | passes — PPT06 `ℓ=2` quadrupole is independent of any shedding data |
...
Adler tongue all remain — they are produced by PPT06/FD06/FD03/CQ41 with no
...
- the existence and two-sidedness of the wake (`ℓ=2`, PPT06 `law_VI` quadrupole `r⁻³`);
...
1. **The plateau value is a convergence, not a derivation.** `κ_clock = 0.45`
   ...
   CQ41/PPT06 wake-roll-up calculation (a lattice/ODE roll-up of the separated
...
- **CQ41 / PPT06 wake-roll-up solve** → derive `κ_clock` parameter-free; would
