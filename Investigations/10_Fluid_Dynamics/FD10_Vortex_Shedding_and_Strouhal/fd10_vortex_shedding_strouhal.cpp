...
//  (PPT06 traction, law_VI::traction). The dragged layer cannot stay attached
...
//    - lock-in as CQ41/PPT06 entrainment of the relaxation oscillator
//
...
//              from FD06 geometry + PPT06 ell=2; coefficient CALIBRATED(1)]
...
// ---------------------------------------------------------------------------
//  PHASE 5 — lock-in (entrainment) of the relaxation oscillator (CQ41/PPT06)
//
...
int main() {
    ...
    // ---- PHASE 1: the clock ------------------------------------------------
    std::printf("PHASE 1 — relaxation/gear clock (PPT06 traction + FD06 separation)\n");
    ...
    std::printf("PHASE 5 — lock-in / entrainment (CQ41/PPT06 Adler oscillator)\n");
