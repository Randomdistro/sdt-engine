...
static void phase1_no_slip_fixed_point()
{
    ...
    // Engine traction quantities (PPT06, law_VI::traction)
    ...
    std::printf("  PPT06 traction ledger (from law_VI::traction):\n");
...
int main()
{
    ...
    std::printf("                     update (PPT06); lambda_s ~ l_P; pin << advection.\n");
