...
*This investigation inherits the §0 anti-creep protocol and rules R0–R5 verbatim (derivation basis inputs only; no G/M/GM fundamentals; no fields/wavefunctions/quarks/virtual particles/ΛCDM/magnetons; certification labels on every result; translation test on every borrowed term; honesty over success).*
