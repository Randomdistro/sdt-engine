 ...
 * @brief FLM05: Lattice Pulse Propagation — Non-Contact Mechanism
 *
...
static void part1_gap_geometry()
{
    ...
    prove("FLM05-1b", "V_disp_p / V_disp_e = m_p/m_e = 1836.15",
...
static void part3_rotorpause()
{
    ...
    prove("FLM05-3a", "Rotorpause at 97.7% of a₀",
          r_rp / a_0, 0.9772, 0.1);
    ...
    prove("FLM05-3b", "Flail tail angle ≈ 1.34°",
...
static void part4_temperature()
{
    ...
    prove("FLM05-4a", "u_rec/u_CMB = (T_rec/T_CMB)^4 ≈ 1.46e12",
          ratio_u, 1.46e12, 5.0);
...
static void part5_light()
{
    ...
    prove("FLM05-5a", "Koppa redshift z = 1/k² = 3.35",
          z_koppa, 3.35, 1.0);
}
...
static void part6_trefoil_cmb()
{
    ...
    prove("FLM05-6b", "Toroidal period = Poloidal period (knot closure)",
          T_tor, T_pol, 0.1);
    ...
    prove("FLM05-6c", "CMB replenishes proton energy in t_P/3",
...
{
    std::puts("================================================================");
    std::puts("  FLM05: LATTICE PULSE PROPAGATION");
