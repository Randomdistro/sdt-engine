...
static void part2_state_framework()
{
    ...
    std::printf("  Coulomb/Gravity force ratio estimate is handled by laws::law_III (EMC01/GOM02).\n\n");
}
...
static void part3_driven_orbit(double koppa_H)
{
    ...
    prove("FLM03-4a", "v_field(a₀) = αc (resonance)",
...
{
    std::puts("================================================================");
    std::puts("  FLM03: SPATION ROTATION KINEMATIC MAP");
