...
﻿# FLM01: State28D Force Ratio Constants — Derivation from Pure SDT
...
Particles have discrete topologies (W=1 electron, W=3 proton from PPT01). Each topology determines its exclusion volume V_disp. The mass is:
...
where v_T comes from the velocity budget v_T² + v_P² = c² (from PPT01).

For an electron:
- v_T = c/√2 (from PPT01, W=1)
- m_e = (Φ/ℓ_P³c²) × V_e
...
*FLM01 · upgraded 2026-06-27 · execute with `PROMPT_EXECUTION_PROTOCOL.md`.*
