# CR05 Phase 1: Spation Pressure Tensor Derivation
...
**CR05 Phase 2** derives the adiabatic equation of state and shows why γ should NOT be 1.33 or 1.4 (borrowed from cosmology), but rather emerges from SDT topology.

**CR05 Phase 3** uses this pressure tensor to solve the Friedmann equation and derive H₀ self-consistently.
...
- **APS03:** Scale Invariance & Drafting Crossover (topological linking number evolution)

---

## Files Included

This is Phase 1 of CR05.
