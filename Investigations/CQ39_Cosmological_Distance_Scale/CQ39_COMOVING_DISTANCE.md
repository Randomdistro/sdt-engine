# CQ39 Phase 2: Comoving Distance Calculation
...
The transfer function f = P_eff / P_conv is Class E (calibrated) because it depends on R_CMB, currently Class X (observed external input). If R_CMB can be derived from SDT first principles, f upgrades to Class C, achieving full transfer-function closure (CQ33).
...
This is speculative but worth investigating in CQ40.
...
**CQ40:** "Derive H₀ from SDT Spation Pressure Tensor"
...
- Phase 1: Lattice Resonance Analysis (CQ39-Phase1)
- Phase 3: Topological Phase Transition (CQ39-Phase3)
- Theory/02_Inputs_and_Derivations.md (SDT closure stages)
- CQ33: Transfer Function Closure (shows H₀ / R_CMB dependency)
