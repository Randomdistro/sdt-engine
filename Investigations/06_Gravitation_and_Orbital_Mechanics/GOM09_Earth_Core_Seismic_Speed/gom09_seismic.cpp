/**
 * @file gom09_seismic.cpp
 * @brief GOM09: Earth Core Seismic Speed — SDT First-Principles Computation
 *
...
int main() {
    ...
    std::printf("╔══════════════════════════════════════════════════════════════════╗\n");
    std::printf("║  GOM09: Seismic Speed from SDT Convergence Gradient              ║\n");
