...
> **Parent**: GOM10 (Three-Body Lagrange from Koppa)
...
- Compare to the existing `gom10_lagrange.cpp` analytical solver
...
- The existing `gom10_lagrange.cpp` solves the collinear points analytically
