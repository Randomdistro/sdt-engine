# GOM40b — Energy-form solar **K** + local-**k** delay-rate (SCE1)
...
| ID | Claim |
|---|---|
| GOM40b-C1 | Validation A PASS (eccentric mock). |
| GOM40b-C2 | Validation B PASS — **K = a/k²** identity. |
| GOM40b-C3 | Dual-arc energy-form **K** COMPUTED; **K** not fitted to ODF. |
| GOM40b-C3b | SMA **a ∈ [1.4, 1.6]×10¹¹ m** or label **`ARC_INSUFFICIENT`** (Amendment 01). |
| GOM40b-C3c | Year EMB D1-cal route if SCE1 insufficient (Amendment 01). |
| GOM40b-C4 | CV(**K_recon**) < 1×10⁻³ on the accepted (SMA-OK) arc. |
| GOM40b-C5 | Local-**k** ledger + **Δt**, **dΔt/dt** published for conjunction samples. |
| GOM40b-C6 | No EMPIRICALLY SURVIVES / residual-correlation claim. |
