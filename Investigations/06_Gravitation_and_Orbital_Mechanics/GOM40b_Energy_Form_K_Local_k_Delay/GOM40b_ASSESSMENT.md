...
| ID | Status |
|---|---|
| GOM40b-C1 | **PASS** — eccentric mock |
| GOM40b-C2 | **PASS** — **K = a/k²** identity |
| GOM40b-C3 | **PASS** — dual route executed; **K** not ODF-fitted |
| GOM40b-C3b | **ARC_INSUFFICIENT** — SCE1 Earth 4-day: **a = 3.53×10¹¹ m**, **K = 927.1 m** (discarded) |
| GOM40b-C3c | **PASS** — EMB 2025 year: **K = 1476.354 m**, **a = 1.496×10¹¹ m**, **k = 1.006719×10⁴** |
| GOM40b-C4 | **PASS** — year CV(**K_recon**) = 1.06×10⁻⁵ |
| GOM40b-C5 | **PASS** — local-**k** + **Δt**, **dΔt/dt** published |
| GOM40b-C6 | **PASS** — no EMPIRICALLY SURVIVES |
...
| Energy-form **K** for SCE1 delay | **YEAR_IC** (GOM40b / GOM26) — SCE1 short-arc excluded |
