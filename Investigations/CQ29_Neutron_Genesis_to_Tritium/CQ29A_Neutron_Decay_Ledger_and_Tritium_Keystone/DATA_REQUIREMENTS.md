# CQ29A — Data Requirements *(decay ledger + tritium keystone)*

*(Single copy — no duplication. The `3n→t` genesis inputs `Q(3n)` and the 3n-kinetics unknown live in CQ29B, not here.)*
