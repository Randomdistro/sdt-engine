# CQ29A — Provenance Classification *(corrected)*
...
**Tally (CQ29A):** **A 3 · C 7 · C-flagged 4 · D 2 · E 1 · F 3.**
*(C-flagged = A2, D1-form, H1-interp, H2. The 3 F = C1 τ_n, D2 lever, D1+D2 full ratio. The 3n-genesis kinetics F lives in CQ29B, not counted here.)*

## The keystone, stated honestly (doctrinal wording)

> CQ29A proves that the **free-neutron β-decay ledger** and the **tritium β-decay ledger** are the *same energetic spine* viewed through different binding environments.
