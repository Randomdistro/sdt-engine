// ============================================================================
//  CQ29B — Three-Neutron Genesis Gate
...
//             Investigations/CQ29_Neutron_Genesis_to_Tritium/CQ29B_Three_Neutron_Genesis_Gate/cq29b_genesis_gate.cpp /Fe:cq29b.exe
...
int main(){
    ...
    std::printf("CQ29B - THREE-NEUTRON GENESIS GATE  (3n -> triton + e + nu_bar)\n");
    ...
    std::printf("\n[CQ29B done]  energy gate closes; genesis rate remains an open problem.\n");
    return 0;
}
