...
> shares the P_eff coefficient caveat ([[EMC01]], [[CR03]]).
...
> unit-bridge** (EMC02: e is a *unit*, not a derived charge — you do not derive a unit). Throughout
...
- **The close-approach win is occlusion saturation.** Once protons are crushed toward 1–2 fm, the
  occlusion fraction **saturates** (g: 1→2, the very effect that whips the sungrazer in CR07), and
...
- The **quantitative** step: deriving that the handed (ℓ=1) surplus has the exact Coulomb magnitude
  ...
  the P_eff coefficient, which is imported/flagged ([[EMC01]], [[CR03]], P_eff provenance).
  **One derivation, two locks:** because P_eff is hydrogen-calibrated *to the Coulomb force*, this
  same handedness derivation would *earn* P_eff and close the **EMC01 class-E circularity** (f and
  P_eff/P_conv being one equation twice). One calculation discharges both EMC03's magnitude and EMC01's
...
charge = occluded influx directionality ([[EMC02]]), the **convergence-as-throughpole** ontology
(no monopoles; light = emission), and the two-regime / occlusion thread. The occlusion **magnitude**
caveat — and its closure — is shared with [[EMC01]]/[[CR03]].*
