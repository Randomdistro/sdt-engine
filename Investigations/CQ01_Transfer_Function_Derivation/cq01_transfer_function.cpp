 ...
 * @brief CQ01: Transfer Function f Derivation — Is f Universal?
 *
 * THE QUESTION:
...
static void step1_what_f_is()
{
    ...
    prove("CQ01-1c", "f = 4*alpha*hbar*c / (pi*R_p^2*r_e^2*P_conv)",
    ...
    std::printf("  = %.6e\n", f_expanded);
    prove("CQ01-1d", "Full expansion matches f",
...
static void step2_universality()
{
    ...
    prove("CQ01-2a", "Coulomb force at 1 Angstrom",
    ...
    prove("CQ01-2d", "Nuclear occlusion > Coulomb at fm scale",
...
{
    std::puts("================================================================");
    std::puts("  CQ01: TRANSFER FUNCTION f DERIVATION");
