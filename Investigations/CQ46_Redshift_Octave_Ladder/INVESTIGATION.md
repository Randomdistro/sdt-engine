# CQ46 — Redshift, the Octave Ladder, and Why Light Does Not Compound
...
> [[CQ45]] (emission/propagation split) and the cyclic-cosmology programme. Nothing here
...
is the same **[FRONTIER]** as §7 (cyclic cosmology, [[CQ45]]).
...
the grid (see [[CQ45]] companion note and the walkthrough). Count halvings down. Each octave
...
- The **cosmological source** of the large-scale spation-size gradient (why our spations differ
  from a distant source's) — the emission/propagation split is [[CQ45]]; the no-expansion
...
Builds on [[CQ43]] (variable closure), [[CQ45]] (emission/propagation), the Depth–Closure
