...
- No-slip condition as the stable fixed point `u*=u_wall` of the CQ14 relay-traction update.
...
**Spation traction (CQ14) derives no-slip and the `√(νx/U)` boundary-layer law natively
