...
|---|---|---|
| **No-slip** `u(wall)=u_wall` | **NATIVE (Class C)** | Stable fixed point of the CQ14 relay-traction update; `λ_s ≪ ℓ_P` |
...
`ω_max(R) = c/R`. The unrelayed mismatch is the **traction ratio** (CQ14, `law_VI::traction`):
...
|---|---|---|---|
| `T = 3(W+1)` | 12 | DERIVED | `law_VI::traction::traction_ratio_proton` (CQ14) |
