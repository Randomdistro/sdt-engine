...
> into the derivation. Internal SDT results (FD06 traction, FD02 ν, FD05 nozzle, CQ14) are *not*
...
- `law_VI::traction` (CQ14), `law_III` occlusion, `law_V` movement budget, `bridge` koppa — from `Engine/include/sdt/laws.hpp`.
