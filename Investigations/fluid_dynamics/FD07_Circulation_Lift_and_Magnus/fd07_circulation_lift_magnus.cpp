...
//    CQ14 ℓ=2 rotational TRACTION channel (law_VI::traction). Lift is the
...
namespace traction = sdt::laws::law_VI::traction;  // CQ14 ℓ=2 channel
...
int main(){
    ...
    // sanity: CQ14 ℓ=2 traction channel is wired in the engine -----------------
    std::printf("[engine] CQ14 ℓ=2 traction channel present: traction_ratio_proton"
    ...
    std::printf("     channel (CQ14) + the Law-V relay ceiling. NO G/M anywhere.\n");
