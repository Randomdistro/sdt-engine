...
- **ℓ=2 rotational traction** (CQ14, `law_VI::traction`): the lattice's organised
...
| `traction_ratio_proton = 3(W+1)` | `12` | SDT-DERIVED (CQ14) | ℓ=2 channel that *is* bound `Γ` |
...
asymmetry (Law III) + the ℓ=2 traction channel (CQ14) + the Law-V ceiling. The
