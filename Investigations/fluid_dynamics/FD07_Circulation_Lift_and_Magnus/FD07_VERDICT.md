...
| Bound `Γ` = continuum of ℓ=2 traction (CQ14) | SDT-derived (internal) | internal-only | **C** | passes |
...
- **NATIVE / DERIVED (Class C):**
  ...
  - `Γ` as the continuum coarse-graining of the CQ14 ℓ=2 traction channel, and
