...
### 1.1 Source of the sheddable vortex — CQ14 traction

A body in flow cannot pass through the spation lattice without dragging it
(`law_VI::traction`, CQ14). The proton trefoil's traction is the microscopic
...
| `ℓ=2` two-sided street | — | **DERIVED** | CQ14 `law_VI` quadrupole `r⁻³` |
