...
- **CQ02 (Vortex Equilibrium Quantisation)** / **CQ36 (Winding Number Stability)** — vortex modes and `W=1` stability that ground the circulation quantum and superfluid phase-lock.
...
**Related:** Law VI traction/confinement (`law_VI::traction::ω_demand`) for the knot-scattering length; CQ08 (GPI) for the momentum-flux relay.
