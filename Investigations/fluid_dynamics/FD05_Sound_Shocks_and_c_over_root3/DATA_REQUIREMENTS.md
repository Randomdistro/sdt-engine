...
| Radiation fluid (relativistic limit) | `c/√3 = 1.7321×10⁸` | m s⁻¹ | 4 sig figs | Phase 2 ceiling; matches CQ39 BAO `c_s` |
...
- `c_s = c/√3` coupled-lattice / BAO sound speed — from **CQ39** (internal result, re-derived here).
