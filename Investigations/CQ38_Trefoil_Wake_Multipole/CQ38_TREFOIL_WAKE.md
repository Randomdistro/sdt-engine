...
**Dependency:** CQ14 (spation traction), CQ09 (rotation field), CQ34 (angular DOF), Law VI (topology)  
...
From CQ14, the phase velocity at the proton surface is v_phase = c/k_surface ≈ 1.831c (superluminal). The spation lattice cannot relay faster than c, so the velocity deficit is converted into three wake channels (traction, rotation, entrainment).
...
| v_phase | Phase velocity at R_p | 1.831c | CQ14 |
...
2. **CQ14 (Spation Traction):** Phase velocity derivation, three outputs (traction, rotation, entrainment)
3. **CQ09 (Rotation Field):** Velocity field v(r) = (c/k)√(R/r) — orbital velocity law
4. **CQ34 (Angular DOF):** Problem statement — angular structure from trefoil, not QM
