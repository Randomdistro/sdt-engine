# CQ11: Trefoil Confinement — INVESTIGATION RESULTS
...
**CQ11 RESOLVED.** Strong force confinement and string breaking are derived purely from the geometry of the convergent throughput field acting on the topology of the (2,3) trefoil. The linear potential is a necessary consequence of the surrounding isotropic pressure collimating the throughput tube.
