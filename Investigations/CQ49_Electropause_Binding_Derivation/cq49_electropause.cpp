// =====================================================================================
//  CQ49 — The Electropause: deriving the electrostatic binding (and P_eff) from the
...
//        (delete-test) -> P_eff upgrades E -> C (CQ01 circularity closed, on framework
...
//  Build (GCC/Clang):
//    g++ -std=c++20 -IEngine/include cq49_electropause.cpp -o cq49
// =====================================================================================
...
int main() {
    ...
    std::printf("=====================================================================\n");
    std::printf("  CQ49  THE ELECTROPAUSE  -  binding (and P_eff) from kinematics\n");
