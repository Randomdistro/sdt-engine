...
**Status change:** `P_eff` **E (CALIBRATED) → C (DERIVED)**. Closes the [[CQ01]] coefficient
circularity and completes the [[CQ47]] "two-locks" step.

**Honest residual (the entire caveat):** α is read as the kinematic k-rung ([[CQ03]]), not the Coulomb
