# CQ23: 3D Volumetric Eclipse Saturation  
...
> **Prerequisites:** `laws.hpp`, `galactic.hpp`, E46 failure analysis  
...
CQ23 must obey strict zero-parameter rules.
...
CQ23 must test at least four classes:
...
10. the E46 galaxy-rotation investigation can be rerun using the 3D volumetric engine.
...
5. a rerun E46 comparison using the 3D volumetric model;
