 ...
 * @brief CQ43: Variable Spation Closure, the Light-Speed Gradient & Lumiostasis
 *
 ...
 *
 * UNIFICATION (CQ15 depth ⊕ CQ42 closure):
 ...
 *   CQ15; now read as "the spations are smaller," not "more shells").
 *
...
int main(){
  std::puts("================================================================");
  std::puts("  CQ43: VARIABLE SPATION CLOSURE, c-GRADIENT & LUMIOSTASIS");
  ...
  const double M_MW   = 6.0e10;                       // M_sun baryonic (E46/CQ20)
  ...
  prove("CQ43-I.1","z = 1 − c_local/c  (light-speed deficit = depth)",
        1.0 - c_surf/c, z_surf, 1e-6);
  prove("CQ43-I.2","z = 1 − ℓ_P(r)/ℓ_P,∞  (closure deficit = depth)",
  ...
  prove("CQ43-III.1","lumiopause: L_sun/(4π r²) = F_CMB exactly",
  ...
  prove("CQ43-IV.1","closure-deficit Shapiro = standard formula number",
