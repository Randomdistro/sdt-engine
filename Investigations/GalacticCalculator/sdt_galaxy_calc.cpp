...
//
// PHYSICS (from CQ06 eclipse saturation model):
...
// =============================================================================
// SDT FIELD SCALARS (from CQ06, all from laws.hpp — no G imported)
// =============================================================================
...
// Total galactic Koppa from baryon mass (CQ06 derivation chain, no G)
static double Koppa_gal(double M_bar_msun) {
    return M_bar_msun * Koppa_sun;  // = N_bar × Koppa_per_baryon
}

// Enclosed mean surface density within R for exponential disk (CQ06)
...
// Eclipse fraction from enclosed surface density (CQ06)
...
// Disk velocity from eclipse saturation model (CQ06 Step 7)
