// CQ42 Phase 2 — Planck's floor, recast in KOPPA. James's bet: simpler via koppa.
...
console.log("  ϟ carries G  (ϟ=Gm/c²) UNLESS taken from kinematics ϟ=v²R/c² (CQ24, G-free).");
...
console.log("  -> but per CQ42 seed theorem, ONE absolute anchor still required (the koppa/mass).");
