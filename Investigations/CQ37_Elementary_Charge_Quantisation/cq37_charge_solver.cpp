 ...
 * @brief CQ37 Investigation: Elementary Charge from Lattice Topology
 ...
 *    Requires CQ36 linking-number computation
 *
...
//
// Requires CQ36: computation of Lk for hydrogen bound state
// ═══════════════════════════════════════════════════════════════════════
...
void test_candidate_2_linking_number() {
    ...
    printf("STATUS: DEFERRED to CQ36\n");
...
// At equilibrium, v_T = α c (from CQ03).
...
void test_candidate_3_W1_boundary_radius() {
    ...
    // But CQ03 showed this is circular: r_e is defined TO BE α × λ_C_e.

    printf("\nCIRCULARITY DETECTION:\n");
    printf("  r_e is DEFINED as α × ℏ / (m_e c) in the standard model.\n");
    printf("  We cannot derive e from r_e without already knowing α.\n");
    printf("  And CQ03 proved α cannot be derived from W=1 torus geometry alone.\n");
    printf("  Therefore, Candidate 3 REQUIRES solving CQ03 first.\n\n");
...
int main() {
    ...
    printf("\n╔════════════════════════════════════════════════════════════════╗\n");
    printf("║ CONCLUSION FROM CQ37 ANALYSIS                                 ║\n");
    printf("╚════════════════════════════════════════════════════════════════╝\n");
    ...
    printf("CANDIDATE 2 (Linking Number): DEFERRED to CQ36.\n");
    ...
    printf("CANDIDATE 3 (W=1 Boundary): REQUIRES solving CQ03 first.\n");
    printf("  The coulomb identity e² = α ℏ c / k_e is exact but circular.\n");
    printf("  r_e = α ℏ / (m_e c) defines α, and CQ03 showed α is a Tier-1 input.\n\n");
    ...
    printf("  1. Complete CQ36: compute Lk(hydrogen) explicitly.\n");
