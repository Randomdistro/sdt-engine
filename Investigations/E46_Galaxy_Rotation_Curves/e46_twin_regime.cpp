// =====================================================================
//  E46 (twin-regime): Galaxy Rotation Curves — Bulge (+) Disk (+) Gas
//  ---------------------------------------------------------------------
...
//             same koppa law nails the solar system (Mercury, CQ24).
//
...
//  gradient is grad_perp z = koppa * b / r^3  (CQ15 line 449). Integrating
//  this 1/r^3 kernel along an extended line at impact parameter b gives
//      int (b / r^3) dl = 2 / b   (CQ15: the 4koppa/b lensing result).
...
int main(int argc, char** argv) {
    ...
    std::printf("================================================================\n");
    std::printf(" E46 TWIN-REGIME: spherical bulge (+) occlusion disk (+) gas\n");
