...
//  saturation model (CQ23 / galactic.hpp::predicted_velocity_3d).
//
...
int main(int argc, char** argv) {
    std::cout << "================================================================\n";
    std::cout << " E46: Galaxy Rotation Curves from Eclipse Saturation\n";
    std::cout << " Real SPARC sample  x  SDT 3D volumetric model (CQ23)\n";
    std::cout << "================================================================\n\n";
