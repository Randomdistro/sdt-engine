# CQ40 Phase 3: Hubble Equation from Lattice Pressure
...
From CQ39, the linking number density scales as:
...
The expansion rate is driven by the **resonant coupling** between the topological phase transition (CQ39 Phase 3) and the pressure tensor evolution.
...
**Key insight from CQ39:** The BAO scale λ_BAO sets a characteristic length scale. The Hubble distance scale is:
...
3. Solve for H₀ to match R_CMB from CQ39
...
**CQ40 Phase 4** derives the topological freeze-out at recombination, showing how the transition at z ≈ 1100 reshapes H(z) from radiation-like (H ∝ a⁻²) to matter-like (H ∝ a⁻³/²).
...
- **CQ39:** Linking number evolution and topological transition
