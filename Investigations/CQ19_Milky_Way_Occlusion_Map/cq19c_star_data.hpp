...
add("E24/W7",     "O9-9.5III?", 1.68,  285);
add("E25/W14",    "O8.5-9.5I?", 1.72,  277);
add("E26/16SSW",  "O8-9.5I",    1.75,  149);
add("E27/IRS16CC","O9.5-B0.5I", 2.08,   97);
add("E28/16SSE2", "B0-0.5I",    2.08,  144);
add("E29",        "O9-B0",      2.08,   53);
add("E30/16SSE1", "O8.5-9.5I",  2.09,  140);
add("E31/IRS29N", "WC9",        2.14,  316);
add("E32/16SE1",  "WC8/9",      2.18,  128);
add("E33/IRS33N", "B0.5-1I",    2.19,  182);
add("E34/16S",    "B0.5-1I",    2.26,  137);
add("E35/29NE1",  "WC8/9",      2.28,  339);
add("E36",        "O9-B0I?",    2.34,   19);
add("E37",        "O8-9I?",     2.62,  335);
add("E38",        "O8-9III/I",  2.76,    5);
add("E39/IRS16NE","Ofpe/WN9",   3.05,   87);
add("E40/16SE2",  "WN5/6",      3.17,  134);
add("E41/IRS33E", "Ofpe/WN9",   3.19,  195);
add("E42",        "BV/III",     3.20,  266);
add("E43",        "O8.5-9.5I",  3.21,  245);
add("E44",        "O9-B0II/I?", 3.29,   53);
add("E45",        "O9-B0I",     3.33,  256);
add("E46/13E1",   "B0-1I",      3.37,  252);
add("E47",        "B0-3I",      3.41,  142);
add("E48/13E4",   "WC9",        3.50,  261);
add("E49/13E3",   "?",          3.53,  262);
