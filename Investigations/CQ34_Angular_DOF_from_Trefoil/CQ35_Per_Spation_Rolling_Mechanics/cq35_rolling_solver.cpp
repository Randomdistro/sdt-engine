 ...
 *
 * Investigates: CQ35 — Derive the per-contact lag coefficient a/r
 ...
 *
 * @author Claude Code (SDT Investigation CQ35)
 * @date June 2026
 */
...
inline constexpr double v_trefoil_eq   = 1.8301 * measured_constants::c;       // [m/s] trefoil surface velocity at equator (from CQ09)
 ...
 *
 * From CQ09: the observed velocity profile v(r) = v₀√(R_p/r)
...
void save_results_to_file() {
    ...
    fprintf(fp, "CQ35 ROLLING SOLVER RESULTS\n");
    fprintf(fp, "============================\n\n");
...
int main() {
    printf("\n");
    printf("╔════════════════════════════════════════════════════════════════════╗\n");
    printf("║       CQ35: PER-SPATION ROLLING AND GEAR MESH GEOMETRY             ║\n");
