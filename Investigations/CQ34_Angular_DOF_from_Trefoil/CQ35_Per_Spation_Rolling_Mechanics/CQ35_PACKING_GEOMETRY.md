# CQ35: Packing Geometry and Multi-Contact Configuration
...
- **Minor radius**: a_torus derived from aspect ratio R/a = √(3/2) ≈ 1.225 (from CQ02)
  - Thus: a_torus ≈ R / 1.225 ≈ 6.867e-16 m
- **Knot type**: (p, q) = (2, 3) — 2 toroidal wraps, 3 poloidal wraps
- **Surface velocity**: v₀ = 1.8301c at the equator (from CQ14)
...
1. The trefoil circulates at the measured velocities v_T, v_P (from CQ02).
...
- CQ02: Vortex Equilibrium Quantisation — trefoil geometry, v_T, v_P, aspect ratio
- CQ09: Spation Rotation Kinematic Map — target formula v(r) = v₀ √(R_p/r), the a/r candidate
- CQ14: Spation Traction from Trefoil — traction mechanism, gear ratio
