...
**Date:** June 2026  
**Status:** SPEC  
**Dependency:** CQ02, CQ14, Law VI; blocks all L3 fine structure  
...
The rotation field `v(r) = cα√(a₀/r)` is a function of **r only** (CQ09). There is **no native reason** `l = 0` (s) differs from `l = 1` (p). The s-vs-p distinction is borrowed spherical-harmonic language — a structural borrow flagged as M1 in the contamination audit.
...
- Phase velocity v_phase = 1.831c at R_p (from CQ14)
...
- **Feeds:** CQ12/CQ13 emissions, E53/E91 g-2, all L3
