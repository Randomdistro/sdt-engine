...
1. **What don't we know?** — [PPT03] PPT03: Proton-Electron Mass Ratio — Mathematical Framework: *(unfilled by the 2026-06-27 bulk template upgrade — write the single measurable gap before the next run)*
...
## 3. What PPT01 Provides

From PPT01, the torus volume is:
...
From PPT01, a_e / a_p = (m_p/m_e) / √(5/6) ≈ 2011. So:
...
3. **Self-consistency**: V_disp determines m (Law IV), m determines the Compton wavelength which sets the torus radii (PPT01), and the radii determine V_disp — a coupled system
...
**PPT03 OPEN (blocked).** The mass ratio requires the displaced volume ratio V_p/V_e, which requires solving the 3D lattice perturbation for each knot type. This is the hardest open problem in SDT — it connects topology to mass.
---
...
*PPT03 · upgraded 2026-06-27 · execute with `PROMPT_EXECUTION_PROTOCOL.md`.*
