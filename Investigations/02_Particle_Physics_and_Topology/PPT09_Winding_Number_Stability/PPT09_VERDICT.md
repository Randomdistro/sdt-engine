...
|------------|----------|--------|
| PPT01 (Vortex Equilibrium) | Velocity partition, helical coupling | ✓ Fully integrated |
| PPT05 (Trefoil Confinement) | (2,3) energy estimates | ✓ Referenced |
...
### Short term (Investigations extending PPT09):
...
- **Mass spectrum**: Connect W and a to fundamental scales via V_disp (PPT03 extension)
...
- **PPT01**: Vortex Equilibrium Quantisation (5/5 proofs passed)
- **PPT05**: Trefoil Confinement (energy of (2,3))
...
**PPT09 Investigation**: Winding Number Stability and Reconnection Dynamics
...
**Next Investigation**: EMC02 (to be determined based on remaining open problems in Law VI or atomic-scale refinements)
