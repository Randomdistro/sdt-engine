...
From PPT01, the (2,3) torus knot vortex (proton) has:
...
- ✓ Consistent with PPT01 topology and Law VI
...
### Observable Predictions (Test of PPT09)
...
- **PPT01**: Vortex Equilibrium Quantisation (velocity partition, winding number)
- **PPT05**: Trefoil Confinement (detailed energy of (2,3))
