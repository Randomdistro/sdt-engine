...
|----------|--------|-------|-----------|-----------|
| Transfer function | f | 2.123360 × 10⁻¹⁷ | [dimensionless] | laws.hpp:CQ01 |
| Convergence pressure | P_eff | ~10⁴⁸ | Pa | laws.hpp:bridge |

## Derived Scales (To Be Computed in CQ04)
...
CQ04 is a pure derivation; no experimental data beyond CODATA 2018.
