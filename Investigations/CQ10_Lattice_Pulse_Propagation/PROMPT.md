# CQ10: Lattice Pulse Propagation — The Non-Contact Mechanism
...
This connects the CMB temperature, the recombination epoch, the solar transition region, and the interspation gap in a single framework. CQ10 must test this quantitatively.
