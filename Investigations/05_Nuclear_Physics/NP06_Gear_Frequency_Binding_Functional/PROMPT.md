...
1. **What don't we know?** — [NP06] CQ-50 — THE GEAR-FREQUENCY BINDING FUNCTIONAL: *(unfilled by the 2026-06-27 bulk template upgrade — write the single measurable gap before the next run)*
...
- Phase thresholds (committed before run): 1%, 0.08%, 15%
...
*NP06 · upgraded 2026-06-27 · execute with `PROMPT_EXECUTION_PROTOCOL.md`.*
