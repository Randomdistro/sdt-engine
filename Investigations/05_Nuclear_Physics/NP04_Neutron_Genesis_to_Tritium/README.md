# NP04 — Neutron → Tritium (split per scope-honesty audit)
...
**Highest-value follow-ups:** (1) derive `a_p/a_e = 11.445` from (2,3)-vs-(1,1) knot equilibrium → retires the mass-ratio numerology (NP04A D2); (2) the `3n` capture kinetics / cross-sections (NP04B F0b).

*Numbering note: `NP03` is the Nuclear–Electronic Geometry Mirror Falsification Test; the neutron arc is `NP04`.*
