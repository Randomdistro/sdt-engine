// ============================================================================
//  NP04 — Neutron Genesis: free neutron -> beta-decay (winding split) -> tritium
//
...
//       Investigations/CQ29_Neutron_Genesis_to_Tritium/cq29_neutron_genesis.cpp /Fe:np04.exe
//    g++ -std=c++20 -O2 -IEngine/include \
//       Investigations/CQ29_Neutron_Genesis_to_Tritium/cq29_neutron_genesis.cpp -o np04
//
...
int main(){
    std::printf("NP04A - NEUTRON DECAY LEDGER + TRITIUM KEYSTONE  (the PASSED core)\n");
    std::printf("Ledger: n -> p + e + nu_bar  ...  H3 -> He3 + e + nu_bar\n");
    std::printf("NOTE: 3n -> triton GENESIS is energy-gated ONLY -> see NP04B (kinetics UNRESOLVED).\n");
    ...
    // ── FINAL LEDGER (decay only; genesis is NP04B) ─────────────────────────
    ...
    std::printf("  NOT TESTED HERE: 3n -> triton genesis -> energy-gated only in NP04B; kinetics UNRESOLVED.\n");
