#!/usr/bin/env python3
"""NSEQ13 — occupation/emission energy map from Shared seating (hold-out NSEQ09 MeV)."""
...
def main() -> int:
    print("NSEQ13 occupation/emission energy screen")
    ...
    # Candidates from seating integers + whitelist ONLY (no measured nuclear B_* imports)
