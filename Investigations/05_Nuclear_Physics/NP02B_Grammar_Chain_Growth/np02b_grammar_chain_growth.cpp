// ============================================================================
//  NP02B — Grammar Chain Growth  (Investigation B; companion to NP02)
//
//  A SEPARATE investigation from CQ27_Stellar_Fusion_and_Nuclear_Growth (which
//  runs a 5-stage A->E pipeline). NP02B takes the COMPLEMENTARY angle: it reads
...
//       Investigations/CQ27B_Grammar_Chain_Growth/cq27b_grammar_chain_growth.cpp /Fe:np02b.exe
//    g++ -std=c++20 -O2 -IEngine/include \
//       Investigations/CQ27B_Grammar_Chain_Growth/cq27b_grammar_chain_growth.cpp -o np02b
//
...
int main() {
    std::printf("NP02B — GRAMMAR CHAIN GROWTH  (Investigation B)\n");
