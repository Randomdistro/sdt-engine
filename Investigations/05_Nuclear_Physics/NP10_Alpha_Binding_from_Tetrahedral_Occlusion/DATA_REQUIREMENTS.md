# NP10: Alpha Binding from Tetrahedral Occlusion — Data Requirements
...
| Quantity | Source |
|----------|--------|
| Single p-n occlusion bond energy | NP09 result |
| P_eff nuclear correction (if needed) | NP09 result |
| Neutron effective radius for occlusion | NP09 result |
