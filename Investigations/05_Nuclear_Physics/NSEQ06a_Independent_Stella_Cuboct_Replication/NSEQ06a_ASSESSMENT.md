# NSEQ06a Results — Independent Stella/Cuboct Relation Replication
...
two errors: NSEQ06a incorrectly assembled the expected cuboctahedral direction
...
| Item | Existing status retained | Why NSEQ06a cannot clear it |
|---|---|---|
