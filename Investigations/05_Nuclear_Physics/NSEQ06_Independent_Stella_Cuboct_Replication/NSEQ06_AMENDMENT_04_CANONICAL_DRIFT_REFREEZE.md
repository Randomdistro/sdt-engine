# NSEQ06 Amendment 04 — Canonical Drift Re-freeze

**Date:** 2026-08-09  
**Cause:** `Engine/include/sdt/laws.hpp` changed after the accepted NSEQ06 run.  
**Canon action by NSEQ06:** none; this audit does not alter canonical files.
...
the triton identifiers and adds a pure-shell/stella/cuboct narrative. NSEQ06
...
The following current canonical statements exceed what NSEQ06 establishes:

1. `face-count 12→16→20 EXCLUDED`: NSEQ06 finds only that one stated ad hoc
...
2. `capacities DERIVED` and a shell formation/occupancy narrative: NSEQ06
