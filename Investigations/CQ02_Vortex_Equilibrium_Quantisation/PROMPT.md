# CQ02: Vortex Equilibrium Quantisation — Mathematical Framework

> **Category**: Topology / Mass Spectrum
> **Status**: RESOLVED (5/5 pass)
...
5. **Mass ratio** m_p/m_e = 1836.15 does NOT follow from topology alone — it requires V_disp (→ CQ05).
