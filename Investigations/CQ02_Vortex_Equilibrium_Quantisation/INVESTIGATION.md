# CQ02: Vortex Equilibrium Quantisation — INVESTIGATION RESULTS
...
- This ratio must come from V_disp (Law IV), which is a separate derivation (→ CQ05)

## Proof Results

| Proof | Description | Result |
|-------|-------------|--------|
| CQ02-1a | W=1 budget = c² | **PASS** |
| CQ02-1b | W=3 budget = c² | **PASS** |
| CQ02-2a | a_e/a_p consistency | **PASS** |
| CQ02-3a | (2,3) trefoil budget = c² | **PASS** |
| CQ02-4a | W=2 lighter than W=1 | **PASS** |

## Verdict

**CQ02 RESOLVED.** The discrete mode spectrum follows exactly from v_T² + v_P² = c² with helical coupling. Stable particles are torus knots. Electron = (1,1), proton = (2,3). Mass spectrum is discrete-in-W, continuous-in-a. The m_p/m_e ratio is deferred to CQ05 (depends on V_disp).
