 ...
 * @brief CQ02: R/a Quantisation — Vortex Equilibrium Problem
 *
 * THE QUESTION:
...
static void section1_enumerate()
{
    ...
    prove("CQ02-1a", "W=1 budget v_T^2 + v_P^2 = c^2",
          m1.budget_check, 1.0, 0.001);
    prove("CQ02-1b", "W=3 budget v_T^2 + v_P^2 = c^2",
...
static void section2_identification()
{
    ...
    prove("CQ02-2a", "a_e/a_p = m_p/m_e × sqrt(6)/2",
          a_e / a_p, a_ratio, 0.1);
...
static void section3_stability()
{
    ...
    prove("CQ02-3a", "(2,3) trefoil budget = c^2",
...
static void section4_W2()
{
    ...
    prove("CQ02-4a", "W=2 is lighter than W=1 (same a) → no stable particle",
...
{
    std::puts("================================================================");
    std::puts("  CQ02: VORTEX EQUILIBRIUM QUANTISATION");
