#!/usr/bin/env python3
"""
fetch_nuclear.py  --  CQ26 Scale (D) NUCLEAR data fetcher (AME2020 + NUBASE2020).

Investigation: CQ26 Universal Drafting Crossover, stretch scale (D) (nuclear binding).
...
def download(url, dest, offline, force):
    ...
    req = urllib.request.Request(url, headers={"User-Agent": "Mozilla/5.0 (CQ26 fetch_nuclear.py)"})
...
def main():
    ...
    print("=== CQ26 nuclear fetch (AME2020 + NUBASE2020) ===")
